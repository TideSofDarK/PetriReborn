...
function OpenBasicBuildingsMenu(keys)
	...
	caster:SwapAbilities("petri_empty3", "petri_close_basic_buildings_menu", false, true)
end
...
function OpenAdvancedBuildingsMenu(keys)
	...
	--caster:SwapAbilities("petri_empty1", "petri_empty1", false, true)
	--caster:SwapAbilities("petri_empty2", "petri_empty2", false, true)
	caster:SwapAbilities("petri_empty3", "petri_close_advanced_buildings_menu", false, true)
end
...
function CloseBasicBuildingsMenu(keys)
	...
	--caster:SwapAbilities("petri_empty1", "petri_empty1", false, true)
	--caster:SwapAbilities("petri_empty2", "petri_empty2", false, true)
	caster:SwapAbilities("petri_empty3", "petri_close_basic_buildings_menu", true, false)
...
function CloseAdvancedBuildingsMenu(keys)
	...
	--caster:SwapAbilities("petri_empty1", "petri_empty1", false, true)
	--caster:SwapAbilities("petri_empty2", "petri_empty2", false, true)
	caster:SwapAbilities("petri_empty3", "petri_close_advanced_buildings_menu", true, false)
