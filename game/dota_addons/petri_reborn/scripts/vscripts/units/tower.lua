...
function UpgradeDeath (event)
	...
	UpdateModel(caster, GetModelNameForTower(TOWER_DEATH), 0.62 + (tower_level/30))
...
function UpgradeIce (event)
	...
	UpdateModel(caster, GetModelNameForTower(TOWER_ICE), 0.85 + (tower_level/30))
...
function UpgradeFire (event)
	...
	UpdateModel(caster, GetModelNameForTower(TOWER_FIRE), 0.85 + (tower_level/30))
...
function UpgradeBasic (event)
	...
	caster:SetModelScale(0.4 + (tower_level/30))
