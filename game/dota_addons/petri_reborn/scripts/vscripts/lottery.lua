...
GameMode.LOTTERY_PLAY_COUNT = 0

function InitLottery()
	GameMode.LOTTERY_STATE = 1

	GameMode.CURRENT_BANK = DEFAULT_BANK_RATE * (GameMode.LOTTERY_PLAY_COUNT+1)
...
function SelectWinner()
	...
	GameMode.LOTTERY_PLAY_COUNT = GameMode.LOTTERY_PLAY_COUNT + 1
end