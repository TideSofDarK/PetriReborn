...
function UpdateInventory()
{
	...
	for ( var i = 0; i < DOTA_ITEM_STASH_MAX; ++i )
	{
		...
		if (i >= DOTA_ITEM_STASH_MIN)
			emptyStash = emptyStash && item == -1;
	}

	$( "#stash_row" ).SetHasClass("empty", emptyStash);
}
...
function CreateInventoryPanels()
{
	...
	for ( var i = 0; i < DOTA_ITEM_STASH_MAX; ++i )
	{
		...
		inventoryPanel.BLoadLayout( "file://{resources}/layout/custom_game/inventory/inventory_item.xml", false, false );
